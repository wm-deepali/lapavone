{{-- resources/views/admin/home/audio/edit.blade.php --}}
...
<div class="main-section">
    ...
    .audio-player { width: 100%; margin-top: 10px; border-radius: var(--radius-sm); }
    ...
    <div class="app-content content container-fluid">
        <div class="create-page">
            ...
            <form action="{{ route('admin.home.audio.update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="create-layout">
                    ...
                    <div>
                            ...
                            <div class="section-card-body">
                                <div class="field-group">
                                    ...
                                    <input type="text" name="heading" class="field-input"
                                        value="{{ old('heading', $audio->heading) }}"
                                        placeholder="THE FRAGRANCE OF RESTRAINT.">
                                </div>
                            </div>
                        </div>
                        ...
                        {{-- Section Image --}}
                        <div class="section-card">
                            <div class="section-card-header"><h5>Section Image</h5></div>
                            <div class="section-card-body">
                                <div class="file-upload-area" id="uploadArea">
                                    <input type="file" name="section_image" accept="image/*" id="imageInput">
                    ...
                    <div>
                        ...
                        {{-- Audio File --}}
                        <div class="section-card">
                            <div class="section-card-header"><h5>Audio File</h5></div>
                            <div class="section-card-body">
                                <div class="file-upload-area" id="audioUploadArea">
                                   <input type="file"
       name="audio_file"
       accept=".mp3,.mpeg,.wav,.ogg"
       id="audioInput">
                                    <div class="upload-icon"><i class="fa fa-music"></i></div>
                                    <p>Click or drag audio here</p>
                                    <small>MP3, WAV, OGG — max 20 MB</small>
                                </div>
                                <div id="audioNewName" style="display:none; margin-top:10px; font-size:12px; color:var(--text-hint);">
                                    <i class="fa fa-file-audio-o"></i> <span id="audioFileName"></span>
                                </div>
                                @if($audio->audio_file)
                                    <div style="margin-top:12px;">
                                        <div style="font-size:11.5px; color:var(--text-hint); margin-bottom:6px;">Current audio:</div>
...
document.getElementById('audioInput').addEventListener('change', function () {
    ...
    document.getElementById('audioNewName').style.display = 'block';
    document.getElementById('audioUploadArea').style.borderColor = 'var(--accent)';
});
</script>