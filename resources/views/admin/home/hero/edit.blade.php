                ...
                <div class="create-layout">
                    ...
                    <div>
                        ...
                        <div class="section-card">
                            <div class="section-card-header"><h5>Heading</h5></div>
                            <div class="section-card-body">
                                <div class="field-row">
                                    <div class="field-group">
                                        <label class="field-label">Line 1</label>
                                        <input type="text" name="heading_line1" class="field-input"
                                            value="{{ old('heading_line1', $hero->heading_line1) }}"
                                            placeholder="LUXURY ISN'T LOUDER.">
                                    </div>
                                    <div class="field-group">
                                        <label class="field-label">Line 2</label>
                                        <input type="text" name="heading_line2" class="field-input"
                                            value="{{ old('heading_line2', $hero->heading_line2) }}"
                                            placeholder="IT'S BETTER MADE">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        {{-- CTA Buttons --}}
                        <div class="section-card">
                            <div class="section-card-header"><h5>CTA Buttons</h5></div>
                            <div class="section-card-body">
                                <div class="field-row">
                                    <div class="field-group">
                                        <label class="field-label">Button 1 Label <span class="req">*</span></label>
                                        <input type="text" name="btn1_label" class="field-input"
                                            value="{{ old('btn1_label', $hero->btn1_label) }}"
                                            placeholder="Shop All" required>
                                    </div>
                                    <div class="field-group">
                                        <label class="field-label">Button 1 URL <span class="req">*</span></label>
                                        <input type="text" name="btn1_url" class="field-input"
                                            value="{{ old('btn1_url', $hero->btn1_url) }}"
                                            placeholder="/shop" required>
                                    </div>
                                </div>
                                <div class="field-row">
                                    <div class="field-group">
                                        <label class="field-label">Button 2 Label <span class="req">*</span></label>
                                        <input type="text" name="btn2_label" class="field-input"
                                            value="{{ old('btn2_label', $hero->btn2_label) }}"
                                            placeholder="New Arrivals" required>
                                    </div>
                                    <div class="field-group">
                                        <label class="field-label">Button 2 URL <span class="req">*</span></label>
                                        <input type="text" name="btn2_url" class="field-input"
                                            value="{{ old('btn2_url', $hero->btn2_url) }}"
                                            placeholder="/new-arrivals" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="section-card-body">
                                ...
                                @if($hero->background_image)
                                    <div style="margin-top:12px;">
                                        ...
                                        <img src="{{ asset('storage/'.$hero->background_image) }}" alt="Current"
                                            style="max-width:100%; border-radius:var(--radius-sm); border:1px solid var(--border);">
                                    </div>
                                @endif
                            </div>
