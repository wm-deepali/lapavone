{{-- resources/views/admin/home/banner/edit.blade.php --}}
...
<div class="main-section">
    ...
    <div class="app-content content container-fluid">
        <div class="create-page">
            ...
            <form action="{{ route('admin.home.banner1.update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="create-layout">
                    ...
                    <div>
                        <div class="section-card">
                            <div class="section-card-header"><h5>Heading Text</h5></div>
                            <div class="section-card-body">
                                <div class="field-group">
                                    ...
                                    <input type="text" name="heading" class="field-input"
                                        ...
                                        placeholder="Rooted in culture. Designed for today.">
                                    <div class="field-hint">This text overlays the banner image.</div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="section-card-body">
                                ...
                                @if($banner->background_image)
                                    <div style="margin-top:12px;">
                                        ...
                                        <img src="{{ asset('storage/'.$banner->background_image) }}" alt="Current"
                                            style="max-width:100%; border-radius:var(--radius-sm); border:1px solid var(--border);">
                                    </div>
                                @endif
                            </div>
