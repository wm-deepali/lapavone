                                    ...
                                    <td>
                                        <div class="cart-items-preview">
                                            @foreach($previewItems as $item)
                                                @php $thumb = optional($item->product)->display_image ?? null; @endphp
                                                @if($thumb)
                                                    <img src="{{ asset($thumb) }}" class="cart-thumb"
                                            ...
                                            <div class="expanded-items-grid">
                                                @foreach($items as $item)
                                                    @php
                                                        ...
                                                        $thumb = optional($product)->display_image;
                                                    @endphp
                                                    <div class="expanded-item">
                                                        @if($thumb)
                                                            <img src="{{ asset($thumb) }}" class="expanded-item-thumb"
